...
Example: If you have 4 devices with one 8G FC port each (32Gbps) and they are
...
Use rate limiting on the FCIP on the Brocade systems, don't limit it on the IP
network.
