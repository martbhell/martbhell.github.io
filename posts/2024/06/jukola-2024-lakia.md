...
- 11-12: Toinen paras tulos 0.66. Aika kummalista koska pysähtyin väärällä kummarellä, mutta sain apua :)
- 13-14: 0.975 - aika kova ylämäki.
- 14-15: 0.69 - aika hyvä.
- 15-16: 0.984 (eli vaan 12 juoksija oli nopeampi). Okay tällä juoksin joku muu perässä mutta ne olivat jo otanut heidän
  rasti mikä oli haionassa. Siellä pelto/keiltainen oli myös talo, mikä ei ollut kartassa. En ollut varma että rasti oli
  siellä ylhällä mutta hyvä että se oli koska jos ei olisin niin eksinyt. Kyllä huomasin kun juoksin alaspäin että tä
  oli väärin mutta en uskonut itsensä.
- 17-18: 0.985 tämä oli vaan _vaikea_. En tiedä miksi, mutta käänsin vasemalle koska siellä ollut muut. En uskonut että
  olin linjalla. Ja en ollut muttä juoksin täysin liikaa vasemalle. Pysähtynyt kun näin yksi avokallio misä olin jo
  ollut..
